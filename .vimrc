...
set cindent                             " indent on cinwords set shiftwidth=2                " set shiftwidth to 4 spaces set tabstop=2                   " set tab to 4 spaces
...
" Pathogen call pathogen#infect() call pathogen#helptags()
